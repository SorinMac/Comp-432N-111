...
public class Comp_Lexer {
    ...
    public List<TokenBuilder> Token = new ArrayList<>();
    public int place = 0;
    public int Check_Quote = 0;

    //this will be where the Lexer work happens
    public List<TokenBuilder> Lexer(String code, int line_num){   
        int Check_Comment = 0;
    ...
    public String GetDescription(String unknown_item, int Quote, int line_num){
        String TokenDisc = "";
